...
- **Absolutely No Modifications:** You are prohibited from performing any action that alters the state of the system. This includes:
  ...
  - Before Executing your solution write them in md files. Think like you are guiding an jr engineer. Summarize your tasks with bullet points.
  - The tasks should be broken into atomic structures which you can easily do them.
  - Don't Overengineer and Over complicate.
  - Balance between using Good Design Principles and Inline codes.
